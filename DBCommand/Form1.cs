...
namespace DBCommand
{
    public partial class Form1 : Form
    {
        ...
        {
            StringBuilder results = new StringBuilder();//Создается объект StringBuilder для хранения результата запроса.
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            StringBuilder results = new StringBuilder();//Создается объект StringBuilder для хранения результата запроса.
            using (sqlConnection1)
            {//SQL-запрос, содержащий два запроса:
                ...
                try
                {
                    sqlConnection1.Open();
                    SqlDataReader reader = sqlCommand1.ExecuteReader();
                    bool MoreResults = false;//Устанавливаем значение булевой переменной MoreResults = false.
                    do
                    {
                    ...
                    } while (MoreResults);//Цикл выполняется пока булева переменная = true.
